class UserSerializer
  ...
  attributes :id, :email, :first_name, :last_name, :user_type, :location, :longitude, :latitude, :age, :phone, :total_reviews, :rating, :bio, :confirmed_at, :sign_in_count, :created_at, :last_sign_in_at, :verified
